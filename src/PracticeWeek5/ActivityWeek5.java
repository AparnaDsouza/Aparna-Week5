...
public class ActivityWeek5 {
	...
	public void flightticket() throws InterruptedException {
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath("//input[contains(@placeholder,'From')]")).sendKeys("Bombay");
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath("//input[starts-with(@placeholder,'To')]")).sendKeys("Udupi");
		Thread.sleep(1000);
